...
`;
let PlantList = {'data':[
    {'id':1, 'species':'아누비아스 핀토','thumbnail':'/img/file/pinto.jpeg','amount_of_light':'보통','min_pH':6.2,'max_pH':7.2,'min_temperature':22,'max_temperature':26, 'description':"아누비아스 핀토는 사람에 의해 개량된 품종입니다. 흰색 녹색 패턴은 특정 부분에 녹색 색소인 엽록소가 부족하여 발생하며, 모든 패턴은 고유합니다. 다른 아누비아스 종에 비해 아누비아스 나나 핀토는 성장속도가 느립니다. 아누비아스 나나 핀토를 건강하고 하얗게 유지하려면 더 높은 강도의 조명을 사용하는 것이 좋습니다. 심을 때 벌브를 묻지 않는 것이 중요하고, 유목이나 돌에 묶여 활착하는 것이 가장 잘 자랍니다."},
]}
